...
${parameters.template}
<style>
	<#include "css/bootstrap-select.css">
...
<script>
	...
	//var self = this;
	//self.require([ "js/bootstrap-select" + self.minSuffix + ".js", "js/select2" + self.minSuffix + ".js" ]);
	//jQuery.struts2_jquery.require("js/bootstrap-select.min.js");
	function format(state) {
    	if (!state.element[0].title) return state.text;
        return "<img class='flag' src='${base}/flags/"; + state.element[0].title.toLowerCase() + ".png'/>&nbsp;&nbsp;" + state.text;
    }
