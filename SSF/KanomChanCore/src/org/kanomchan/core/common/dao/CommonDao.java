...
public interface CommonDao {
	 ...
	 */
	public int update(final String jpql)throws RollBackTechnicalException;
	 ...
	 * @throws RollBackTechnicalException 
	 */
	public int update(final String jpql, Object... params) throws RollBackTechnicalException;
	 ...
	 * @throws RollBackTechnicalException
	 */
	public <T extends Object > List<T> findAll(Class<T> clazz) throws RollBackTechnicalException;
	/**
	 ...
	 * @throws RollBackTechnicalException
	 */
	public <T extends Object > List<T> findAll(Class<T> clazz, PagingBean pagingBean) throws RollBackTechnicalException;
	 ...
	 * @return List of Objects return by the query
	 */
//	public <T extends Object > List<T> query(String jpql, final List<Criteria> list)throws RollBackTechnicalException;
//	
//	public <T extends Object > List<T> query(String jpql, String jpqlCount, PagingBean pagingBean, final List<Criteria> criteriaList) throws RollBackTechnicalException;
//	
//	public <T extends Object > List<T> queryLike(String jpql, final List<Criteria> criteriaList ) throws RollBackTechnicalException;
//	
//	public <T extends Object > List<T> queryLike(String jpql, String jpqlCount, final List<Criteria> criteriaList, PagingBean pagingBean ) throws RollBackTechnicalException;
...
//	public <T extends Object >  List<T> nativeQuery(String sql, Object... params) throws RollBackTechnicalException ;
	 ...
	 * <p>
	 * Example : <br/>
	 * 	List<CustomUser> result = (List<CustomUser>) commonDAO.nativeQuery("SELECT USER_ID, FIRST_NAME, LAST_NAME FROM AGI_USER",CustomUser.class) throws RollBackTechnicalException ; <br/>
	 * 	for (CustomUser customUser : result) {			 <br/>
	 * 		System.out.println( customUser.getUserId() + ":" + customUser.getFirstName() + " " + customUser.getLastName() ) throws RollBackTechnicalException ; <br/>
	 * 	} <br/>
	 * 
	 * WARNING : Using Native SQL will may cause losing Database vendor migration ability <br/>
	 * avoid specific vendor SQL Command as possible
	...
	public <T extends Object > List<T> findByProperty(Class<T> clazz, List<Criteria> criteriaList, String langCode) throws RollBackTechnicalException;
