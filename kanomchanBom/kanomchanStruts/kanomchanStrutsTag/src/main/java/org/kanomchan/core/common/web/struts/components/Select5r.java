...
@StrutsTag(
    name="select5r",
    tldTagClass="org.kanomchan.core.common.web.struts.view.jsp.ui.Select5rTag",
    description="Render a select country element",
    allowDynamicAttributes=true)
public class Select5r extends ListUIBean {
    final public static String TEMPLATE = "selectgrouplevel/select5r";
    ...
    public Select5r(ValueStack stack, HttpServletRequest request, HttpServletResponse response) {
