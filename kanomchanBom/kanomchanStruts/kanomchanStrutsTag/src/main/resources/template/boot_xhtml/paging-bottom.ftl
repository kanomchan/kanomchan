...
-->
	...
	<div class="row">
	    <div class="col-md-12">
			<div class="inline">
				...
				<script>
					function rowsPerPage_Bottom_${parameters.id}_select(){
						...
						$('#rowsPerPage_${parameters.id}').val($('#rowsPerPage_Bottom_${parameters.id}').val());
			...
			<ul id="${parameters.id}_pagination_bottom" class="pagination pull-right inline ${parameters.id}_pagination">
