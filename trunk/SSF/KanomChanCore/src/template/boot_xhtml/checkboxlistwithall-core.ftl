...
<input type="hidden" name="${parameters.beanName?html}[${itemCount-1}].${parameters.name?html}" value="${itemKeyStr?html}" id="hidden-${parameters.id?html}-${itemCount}"<#rt/>>
<input type="checkbox" 
		name="${parameters.beanName?html}[${itemCount-1}].${parameters.checkName?html}" 
